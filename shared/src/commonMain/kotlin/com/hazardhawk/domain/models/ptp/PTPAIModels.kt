...
data class PtpAIResponse(
    ...
    val tokenUsage: TokenUsageMetadata? = null // Token usage from Gemini API
)
...
PROJECT INFORMATION:
- Project Name: ${questionnaire.projectName}
- Project Location: ${questionnaire.projectLocation}
- Competent Person / Site Supervisor: ${questionnaire.competentPersonName}
